...
from .video_downloader import download_with_ytdlp
...
@shared_task
def process_youtube_video(video_url, video_id):
    try:
        os.makedirs("temp_uploads", exist_ok=True)
        downloaded_path = download_with_ytdlp(video_url)
        video_path = f"temp_uploads/{video_id}.mp4"
